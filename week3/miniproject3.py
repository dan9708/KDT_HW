...
SMTP_PORT = 465
SMTP_USER = 'thdgus0829@gmail.com'
SMTP_PASSWORD = ''
...
lineNum = 1
while (data['A' + str(lineNum)].value):
    send_mail(data['A' + str(lineNum)].value, data['B' + str(lineNum)].value, keyword + "에 관한 네이버 기사목록 엑셀 파일입니다.", "첨부파일을 참조해주세요", fileName)
    lineNum += 1
